...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_interactive_markers_SOURCE_PREFIX /home/mikelap/GitRepo/home-service-robot/src/turtlebot_interactions/turtlebot_interactive_markers)
  set(turtlebot_interactive_markers_DEVEL_PREFIX /home/mikelap/GitRepo/home-service-robot/devel)
  ...
  set(turtlebot_interactive_markers_INSTALL_PREFIX /home/mikelap/GitRepo/home-service-robot/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_interactive_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mikelap/GitRepo/home-service-robot/src/turtlebot_interactions/turtlebot_interactive_markers/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mikelap/GitRepo/home-service-robot/devel/lib;/home/mikelap/GitRepo/home-service-robot/devel/lib;/opt/ros/noetic/lib)
